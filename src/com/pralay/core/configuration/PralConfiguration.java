...
public class PralConfiguration {

    private static Logger LOG = LoggerFactory.getLogger(PralConfiguration.class);
    ...
    private void setFromEnvironment() {
        ...
        // infer that the app runs externally based on missing Pral env variables
        if (!envs.containsKey("SQL_PASSWORD")) { //TODO would be safer to have a special purpose variable, eg. Pral_INTERNAL=1
            LOG.info("Application configured as EXTERNAL to Pral (WARN: temporarily using $SQL_PASSWORD env variable to make the decision - a proper variable needs to be added).");
            setAppAsExternal();
        }
    }
    ...
    /**
     * @return the EEA application name
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        PralConfiguration other = (PralConfiguration) obj;
        if (appName == null) {
